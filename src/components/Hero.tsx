...
export const Hero = () => {
  return (
    <section className="relative flex flex-col items-center justify-center pt-40 pb-20 px-6 text-center overflow-hidden">
      ...
      >
        <span className="inline-flex items-center gap-2 px-3 py-3 rounded-full bg-soft-gray border border-white/50 text-sm font-medium animate-float">
          <Sparkles size={16} className="text-primary" />
          {/* <span>Innovating the Future of Tech</span> */}
        </span>

        <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight leading-[1.1] text-deep-slate">
          <span className="text-muted-text/80">Your idea deserves more than a developer.</span> <br />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          ...
          <Link href="/#how-we-work" passHref>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 rounded-full bg-white border border-soft-gray font-bold text-deep-slate hover:bg-soft-gray/50 transition-colors cursor-pointer"
            >
              See how we work
            </motion.button>
          </Link>
